...
alg.solve(max_iter=1e5, max_time=3600*24,tol=1e-3,ubd_midpt_fix=1,ubd_local_solve=1,ubd_provided=process_obj,inherit_multiplier=True,aug_lag=True,aug_lag_iter=2)
